...
def k_optimization_generalisation(training_data: str, test_data: str, step_size: int, max_no_improve=3):
    k = 0
    step = step_size
    best_k = k
    ...
    while True:
        bpe_encoder = BytePairEncoder(vocab_size=k, verbose=False, model_path=f"model_{k}k.json")
