...
from utils.preprocessing.normalization import text_normalization
from utils.preprocessing.char_tokenization import character_tokenization
from utils.get_most_frequent_token_pair import get_most_frequent_pair
from utils.extract_vocabulary import extract_vocabulary
from utils.merge_token_pair_in_corpus import update_corpus
...
class BytePairEncoder:
    def __init__(self, vocab_size: int, verbose: bool, model_path: str = None):
        """
    ...
    def fit(self, corpus):
        ...
        self.bpe_codes = sorted(list(extract_vocabulary(corpus)), key=len, reverse=True)
    ...
    def save(self, filepath: str = None):
        ...
        if self.verbose:
            print(f"BPE codes saved to {path}")
    ...
    def load(self, filepath: str = None):
        ...
        if self.verbose:
            print(f"BPE codes loaded from {path}")